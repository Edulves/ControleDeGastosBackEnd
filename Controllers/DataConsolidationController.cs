...
namespace ExpensesControl.Controllers
{
    ...
    public class DataConsolidationController(IConsolidationService expensesControlService) : ControllerBase
    {
        ...
        [ProducesResponseType(StatusCodes.Status200OK, Type = typeof(DailyExpensesPerCategoryResult))]
        ...
        [ProducesResponseType(StatusCodes.Status200OK, Type = typeof(DailyExpensesConsolidationResult))]
        [ProducesResponseType(StatusCodes.Status400BadRequest, Type = typeof(ProblemDetails))]
        [ProducesResponseType(StatusCodes.Status500InternalServerError, Type = typeof(ProblemDetails))]
        ...
        [ProducesResponseType(StatusCodes.Status200OK, Type = typeof(TotalFixedExpensesComparasionResponse))]
        [ProducesResponseType(StatusCodes.Status400BadRequest, Type = typeof(ProblemDetails))]
        [ProducesResponseType(StatusCodes.Status500InternalServerError, Type = typeof(ProblemDetails))]
        ...
        [ProducesResponseType(StatusCodes.Status200OK, Type = typeof(TotalExpensesResponse))]
        [ProducesResponseType(StatusCodes.Status400BadRequest, Type = typeof(ProblemDetails))]
        [ProducesResponseType(StatusCodes.Status500InternalServerError, Type = typeof(ProblemDetails))]
